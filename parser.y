...
%token CONFIG BASE_URL HEADER LET TEST GET POST PUT DELETE EXPECT STATUS BODY CONTAINS
%token <str> IDENT STRING
%token <num> NUMBER

%type <str> config_items config_item
%type <str> statements statement request_stmt request_items request_item expect_stmt
